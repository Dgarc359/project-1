...
public class App {
    ...
    public static void main (String[] args) {
        ...
        String result0 = adeOrm.getColumn0("bank_user", "first_name", "userid", "harry");
        ...
        List<List<Object>> result2 = adeOrm.getColumns2("bank_user", columnNames, "userid", "harry");
        System.out.println(result2);
        List<String> columnNames2 = Arrays.asList("trans_type", "datetime", "amount");
        List<List<Object>> result3 = adeOrm.getColumns2("transfer_transaction", columnNames2, "amount", BigDecimal.valueOf(10));
